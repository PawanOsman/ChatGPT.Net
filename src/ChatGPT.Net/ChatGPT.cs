    ...
    private void InitBrowser()
    {
        Task.Run(async () =>
        {
            ...
            while (true)
            {
                ...
                await Page.AddInitScriptAsync("async function sendMessage(e,t,n,r){return await(await fetch(\"https://chat.openai.com/backend-api/conversation\",{headers:{accept:\"text/event-stream\",\"accept-language\":\"en-US,en;q=0.9\",authorization:`Bearer ${r}`,\"cache-control\":\"no-cache\",\"content-type\":\"application/json\",pragma:\"no-cache\",\"sec-ch-ua\":'\"Not?A_Brand\";v=\"8\", \"Chromium\";v=\"108\"',\"sec-ch-ua-mobile\":\"?0\",\"sec-ch-ua-platform\":'\"Windows\"',\"sec-fetch-dest\":\"empty\",\"sec-fetch-mode\":\"cors\",\"sec-fetch-site\":\"same-origin\",\"x-openai-assistant-app-id\":\"\"},referrer:\"https://chat.openai.com/chat\",referrerPolicy:\"strict-origin-when-cross-origin\",body:JSON.stringify({action:\"next\",messages:[{id:t,role:\"user\",content:{content_type:\"text\",parts:[e]}}],parent_message_id:n,model:\"text-davinci-002-render\"}),method:\"POST\",mode:\"cors\",credentials:\"include\"})).text()}async function sendMessageByConversation(e,t,n,r,a){return await(await fetch(\"https://chat.openai.com/backend-api/conversation\",{headers:{accept:\"text/event-stream\",\"accept-language\":\"en-US,en;q=0.9\",authorization:`Bearer ${r}`,\"cache-control\":\"no-cache\",\"content-type\":\"application/json\",pragma:\"no-cache\",\"sec-ch-ua\":'\"Not?A_Brand\";v=\"8\", \"Chromium\";v=\"108\"',\"sec-ch-ua-mobile\":\"?0\",\"sec-ch-ua-platform\":'\"Windows\"',\"sec-fetch-dest\":\"empty\",\"sec-fetch-mode\":\"cors\",\"sec-fetch-site\":\"same-origin\",\"x-openai-assistant-app-id\":\"\"},referrer:\"https://chat.openai.com/chat\",referrerPolicy:\"strict-origin-when-cross-origin\",body:JSON.stringify({action:\"next\",messages:[{id:t,role:\"user\",content:{content_type:\"text\",parts:[e]}}],conversation_id:a,parent_message_id:n,model:\"text-davinci-002-render\"}),method:\"POST\",mode:\"cors\",credentials:\"include\"})).text()}!function(){let e=HTMLCanvasElement.prototype[name];Object.defineProperty(HTMLCanvasElement.prototype,name,{value:function(){for(var t={r:Math.floor(10*Math.random())-5,g:Math.floor(10*Math.random())-5,b:Math.floor(10*Math.random())-5,a:Math.floor(10*Math.random())-5},n=this.width,r=this.height,a=this.getContext(\"2d\"),o=a.getImageData(0,0,n,r),i=0;i<r;i++)for(var c=0;c<n;c++){var s=i*(4*n)+4*c;o.data[s+0]=o.data[s+0]+t.r,o.data[s+1]=o.data[s+1]+t.g,o.data[s+2]=o.data[s+2]+t.b,o.data[s+3]=o.data[s+3]+t.a}return a.putImageData(o,0,0),e.apply(this,arguments)}})}(),Object.defineProperty(window,\"chrome\",{value:new Proxy(window.chrome,{has:(e,t)=>!0,get:(e,t)=>({app:{isInstalled:!1},webstore:{onInstallStageChanged:{},onDownloadProgress:{}},runtime:{PlatformOs:{MAC:\"mac\",WIN:\"win\",ANDROID:\"android\",CROS:\"cros\",LINUX:\"linux\",OPENBSD:\"openbsd\"},PlatformArch:{ARM:\"arm\",X86_32:\"x86-32\",X86_64:\"x86-64\"},PlatformNaclArch:{ARM:\"arm\",X86_32:\"x86-32\",X86_64:\"x86-64\"},RequestUpdateCheckStatus:{THROTTLED:\"throttled\",NO_UPDATE:\"no_update\",UPDATE_AVAILABLE:\"update_available\"},OnInstalledReason:{INSTALL:\"install\",UPDATE:\"update\",CHROME_UPDATE:\"chrome_update\",SHARED_MODULE_UPDATE:\"shared_module_update\"},OnRestartRequiredReason:{APP_UPDATE:\"app_update\",OS_UPDATE:\"os_update\",PERIODIC:\"periodic\"}}})})}),function(){let e=Object.create(Plugin.prototype),t=Object.create(MimeType.prototype),n=Object.create(MimeType.prototype);Object.defineProperties(t,{type:{get:()=>\"application/pdf\"},suffixes:{get:()=>\"pdf\"}}),Object.defineProperties(n,{type:{get:()=>\"text/pdf\"},suffixes:{get:()=>\"pdf\"}}),Object.defineProperties(e,{name:{get:()=>\"Chrome PDF Viewer\"},description:{get:()=>\"Portable Document Format\"},0:{get:()=>t},1:{get:()=>n},length:{get:()=>2},filename:{get:()=>\"internal-pdf-viewer\"}});let r=Object.create(Plugin.prototype);Object.defineProperties(r,{name:{get:()=>\"Chromium PDF Viewer\"},description:{get:()=>\"Portable Document Format\"},0:{get:()=>t},1:{get:()=>n},length:{get:()=>2},filename:{get:()=>\"internal-pdf-viewer\"}});let a=Object.create(Plugin.prototype);Object.defineProperties(a,{name:{get:()=>\"Microsoft Edge PDF Viewer\"},description:{get:()=>\"Portable Document Format\"},0:{get:()=>t},1:{get:()=>n},length:{get:()=>2},filename:{get:()=>\"internal-pdf-viewer\"}});let o=Object.create(Plugin.prototype);Object.defineProperties(o,{name:{get:()=>\"PDF Viewer\"},description:{get:()=>\"Portable Document Format\"},0:{get:()=>t},1:{get:()=>n},length:{get:()=>2},filename:{get:()=>\"internal-pdf-viewer\"}});let i=Object.create(Plugin.prototype);Object.defineProperties(i,{name:{get:()=>\"WebKit built-in PDF\"},description:{get:()=>\"Portable Document Format\"},0:{get:()=>t},1:{get:()=>n},length:{get:()=>2},filename:{get:()=>\"internal-pdf-viewer\"}});let c,s=Object.create(PluginArray.prototype);s[0]=e,s[1]=r,s[2]=a,s[3]=o,s[4]=i,Object.defineProperties(s,{length:{get:()=>5},item:{value(t){switch(t>4294967295&&(t%=4294967296),t){case 0:return o;case 1:return e;case 2:return r;case 3:return a;case 4:return i}}},refresh:{get:()=>c,set(e){c=e}}}),Object.defineProperty(Object.getPrototypeOf(navigator),\"plugins\",{get:()=>s})}(),function(){window.chrome={},window.chrome.app={InstallState:{DISABLED:\"disabled\",INSTALLED:\"installed\",NOT_INSTALLED:\"not_installed\"},RunningState:{CANNOT_RUN:\"cannot_run\",READY_TO_RUN:\"ready_to_run\",RUNNING:\"running\"},getDetails(){},getIsInstalled(){},installState(){},get isInstalled(){return!1},runningState(){}},window.chrome.runtime={OnInstalledReason:{CHROME_UPDATE:\"chrome_update\",INSTALL:\"install\",SHARED_MODULE_UPDATE:\"shared_module_update\",UPDATE:\"update\"},OnRestartRequiredReason:{APP_UPDATE:\"app_update\",OS_UPDATE:\"os_update\",PERIODIC:\"periodic\"},PlatformArch:{ARM:\"arm\",ARM64:\"arm64\",MIPS:\"mips\",MIPS64:\"mips64\",X86_32:\"x86-32\",X86_64:\"x86-64\"},PlatformNaclArch:{ARM:\"arm\",MIPS:\"mips\",MIPS64:\"mips64\",X86_32:\"x86-32\",X86_64:\"x86-64\"},PlatformOs:{ANDROID:\"android\",CROS:\"cros\",FUCHSIA:\"fuchsia\",LINUX:\"linux\",MAC:\"mac\",OPENBSD:\"openbsd\",WIN:\"win\"},RequestUpdateCheckStatus:{NO_UPDATE:\"no_update\",THROTTLED:\"throttled\",UPDATE_AVAILABLE:\"update_available\"},connect(){},sendMessage(){},id:void 0};let e=Date.now();window.chrome.csi=function(){return{startE:e,onloadT:e+281,pageT:3947.235,tran:15}},window.chrome.loadTimes=function(){return{get requestTime(){return e/1e3},get startLoadTime(){return e/1e3},get commitLoadTime(){return e/1e3+.324},get finishDocumentLoadTime(){return e/1e3+.498},get finishLoadTime(){return e/1e3+.534},get firstPaintTime(){return e/1e3+.437},get firstPaintAfterLoadTime(){return 0},get navigationType(){return\"Other\"},get wasFetchedViaSpdy(){return!0},get wasNpnNegotiated(){return!0},get npnNegotiatedProtocol(){return\"h3\"},get wasAlternateProtocolAvailable(){return!1},get connectionInfo(){return\"h3\"}}}}(),function(){let e=[17632315,17632315,17632315,17634847,17636091,17636751],t=0;Object.defineProperties(Object.getPrototypeOf(performance.memory),{jsHeapSizeLimit:{get:()=>4294705152},totalJSHeapSize:{get:()=>35244183},usedJSHeapSize:{get:()=>(t>5&&(t=0),e[t++])}})}(),Object.defineProperty(navigator,\"maxTouchPoints\",{get:()=>1}),window.Notification||(window.Notification={permission:\"denied\"});const originalQuery=window.navigator.permissions.query;window.navigator.permissions.__proto__.query=e=>\"notifications\"===e.name?Promise.resolve({state:window.Notification.permission}):originalQuery(e);const oldCall=Function.prototype.call;function call(){return oldCall.apply(this,arguments)}Function.prototype.call=call;const nativeToStringFunctionString=Error.toString().replace(/Error/g,\"toString\"),oldToString=Function.prototype.toString;function functionToString(){return this===window.navigator.permissions.query?\"function query() { [native code] }\":this===functionToString?nativeToStringFunctionString:oldCall.call(oldToString,this)}Function.prototype.toString=functionToString,Object.defineProperty(Navigator.prototype,\"webdriver\",{get:()=>!1}),Object.defineProperty(window,\"navigator\",{value:new Proxy(navigator,{has:(e,t)=>\"webdriver\"!==t&&t in e,get:(e,t)=>\"webdriver\"!==t&&(\"function\"==typeof e[t]?e[t].bind(e):e[t])})});");
